...
public class Configuration {
	...
	public static final String BASE_PACKAGE = "com.mamiko";
	
	public static final String PACKAGE_BO = "com.mamiko.bo";
	
	public static final String PACKAGE_DAO = "com.mamiko.dao";
